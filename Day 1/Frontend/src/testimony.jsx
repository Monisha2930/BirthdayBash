          ...
          <div key={testimonial.id} className="testimonial-slide">
            <div className="testimonial-card">
              ...
              <div className="testimonial-info">
                <p className="testimonial-content">{testimonial.content1}</p>
                <p className="testimonial-name">{testimonial.name1}</p>
              </div>
            </div>
            <div className="testimonial-card">
              <img src={testimonial.image2} alt={testimonial.name2} />
              <div className="testimonial-info">
                <p className="testimonial-content">{testimonial.content2}</p>
                <p className="testimonial-name">{testimonial.name2}</p>
              </div>
            </div>
          </div>
        ))}
